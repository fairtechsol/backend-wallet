...
module.exports = class Initial1706875778848 {
    name = 'Initial1706875778848'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "commissions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createBy" uuid, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "matchId" uuid, "betId" uuid, "betPlaceId" uuid NOT NULL, "teamName" character varying NOT NULL, "betPlaceDate" TIMESTAMP WITH TIME ZONE NOT NULL, "odds" numeric(13) NOT NULL DEFAULT '0', "betType" "public"."commissions_bettype_enum" NOT NULL, "stake" numeric(13) DEFAULT '0', "commissionAmount" numeric(13) NOT NULL DEFAULT '0', "commissionType" "public"."commissions_commissiontype_enum", "parentId" uuid NOT NULL, CONSTRAINT "PK_2701379966e2e670bb5ff0ae78e" PRIMARY KEY ("id"))`);
